...
# Docker (Docker-in-Docker) (dind-nftables)
...
```json
"features": {
    "ghcr.io/HarryPeach/docker-in-docker-nftables/dind-nftables:2": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/HarryPeach/docker-in-docker-nftables/blob/main/src/dind-nftables/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
